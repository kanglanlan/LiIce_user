...
public class TimeLineView extends View {
    ...
    private void drawCircle(Canvas canvas, int drawStep, String text, int dx) {
        ...
        canvas.drawCircle(dx, /*getHeight() - this.mRadius -*/ getHeight()/2, this.mRadius, this.mPaint);
        this.mPaint.setStyle(Paint.Style.FILL);
        canvas.drawCircle(dx, /*getHeight() - this.mRadius -*/ getHeight()/2, this.mRadius/2, this.mPaint);
        ...
        if (drawStep%2==1) canvas.drawText(text, dx - getWordCount(text) * this.mTextSize, /*getHeight() - this.mRadius * 2*/ getHeight()/4*3, this.mPaint);
        else canvas.drawText(text, dx - getWordCount(text) * this.mTextSize, /*getHeight() - this.mRadius * 2 - 15*/getHeight()/4, this.mPaint);
    }
    ...
    private void drawLine(Canvas paramCanvas, boolean isStart, int startX, int endX) {
        ...
        paramCanvas.drawLine(this.mRadius * 1.2F + startX, /*getHeight() - this.mRadius -*/ getHeight()/2, endX - this.mRadius * 1.2F, /*getHeight() - this.mRadius -*/ getHeight()/2, this.mPaint);
    }
