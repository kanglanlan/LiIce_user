...
public class BuTieInfoActivity extends BaseActivity {
    ...
    private void init() {
        ...
        tab.setText("评价");
        tablayout.addTab(tab);
        shangpinfragment sqfragment = new shangpinfragment(getIntent().getStringExtra("id"));
        fragments.add(sqfragment);
        pingjiafragment sqfragment2 = new pingjiafragment(getIntent().getStringExtra("id"), "1");
