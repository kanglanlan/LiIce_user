...
public class FG_Pay extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fg_pay, container, false);
    ...
    private void initView() {
        ...
        adapter = new Adapter_IntegralDetail(getActivity(), datas, 2);
    ...
    private void getData(boolean isload) {
        ...
        mRequest.add("type","2");	//积分类型 1收入 2 支出 3全部
